...
import type { DashboardScope,
    DataSource, DataSourceId, DataSourceService,   WorkspaceRepository, WorkspaceScope } from "@avesd/workspace-model";
