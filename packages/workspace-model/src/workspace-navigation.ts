    ...
    switch (command.type) {
        ...
        case "deleteWorkspace":
            if (workspaces.length < 2) {
                throw new Error("Keep at least one workspace.");
            }
        ...
        case "delete": {
            ...
            if (siblings.length < 2) {
                throw new Error("Keep at least one dashboard in this workspace.");
            }
